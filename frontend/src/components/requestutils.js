...
export const fetchFolders = async ({ setFolders, setError }) => {
  try {
    const response = await fetch("https://intense-atoll-92670-862e0116edf6.herokuapp.com/auth/get-folders", {
      method: "GET",
...
export const saveFolders = async ({ folders, setError }) => {
  try {
    const response = await fetch(`https://intense-atoll-92670-862e0116edf6.herokuapp.com/auth/update-folders`, {
      method: "PUT",
      headers: {
...
export const fetchDeck = async ({ id, setDeck, setError }) => {
  try {
    const response = await fetch(`https://intense-atoll-92670-862e0116edf6.herokuapp.com/auth/get-deck/${id}`, {
      method: "GET",
      headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
      credentials: "include",
    });
...
export const fetchDecks = async ({ setDecks, setError }) => {
  try {
    const response = await fetch("https://intense-atoll-92670-862e0116edf6.herokuapp.com/auth/get-decks", {
      method: "GET",
      headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
      credentials: "include",
    });
...
export const createNewDeck = async ({ deckName, cards, folderArray, setDeckName, setError }) => {
  try {
    const response = await fetch("https://intense-atoll-92670-862e0116edf6.herokuapp.com/auth/create-deck", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("token")}`,
...
export const saveDeck = async ({ id, deck, setError }) => {
  try {
    const response = await fetch(`https://intense-atoll-92670-862e0116edf6.herokuapp.com/auth/update-deck/${id}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("token")}`,
...
export const deleteDeck = async ({ id, setError }) => {
  try {
    const response = await fetch(`https://intense-atoll-92670-862e0116edf6.herokuapp.com/auth/delete-deck/${id}`, {
      method: "DELETE",
      headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
      credentials: "include",
    });
...
export const toggleStarred = async ({ deck, currentDeck, deckId, cardId, starred, setDeck, setCurrentDeck, setError }) => {
  try {
    const response = await fetch(`https://intense-atoll-92670-862e0116edf6.herokuapp.com/auth/update-card/${deckId}/${cardId}`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("token")}`,
...
export const deleteAccount = async ({ setLoggedIn, setError }) => {
  try {
    const response = await fetch("https://intense-atoll-92670-862e0116edf6.herokuapp.com/auth/delete-account", {
      method: "DELETE",
      headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
      credentials: "include",
    });
...
export const updateUsername = async ({ newUsername, setNewUsername, setError }) => {
  try {
    const response = await fetch("https://intense-atoll-92670-862e0116edf6.herokuapp.com/auth/update-username", {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("token")}`,
...
export const updatePin = async ({ newPin, setNewPin, setReenteredPin, setError }) => {
  try {
    const response = await fetch("https://intense-atoll-92670-862e0116edf6.herokuapp.com/auth/update-pin", {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("token")}`,
